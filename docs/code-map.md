...
| Animation playback | [`baselib/aobj.c`](../src/sysdolphin/baselib/aobj.c) | The [animation guide](code/animation-playback.md) explains frame requests, loops, and end callbacks. The [track guide](code/animation-tracks.md) follows byte decoding and interpolation in `fobj.c`. |
